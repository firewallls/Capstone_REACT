    ...
    <div className="space-y-8 pb-10">
      ...
      <section className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="md:col-span-1 rounded-2xl bg-card border border-border shadow-sm p-5 flex items-center gap-4">
          <div className="h-14 w-14 rounded-full bg-primary grid place-items-center text-base font-bold text-primary-foreground shadow-sm">N</div>
          <div className="min-w-0">
            <div className="text-sm font-bold truncate">Newton</div>
            <div className="text-[11px] text-muted-foreground truncate">newton@uni.edu</div>
